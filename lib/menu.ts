export type MenuCategory = "rice" | "pho" | "mala" | "spaghetti" | "ramen" | "donkatsu"
...
export const categoryOrder: MenuCategory[] = ["rice", "pho", "mala", "spaghetti", "ramen", "donkatsu"]
...
export const menuItems: MenuItem[] = [
  ...
  {
    id: "clam-chowder-spaghetti",
    name: "클램차우더스파게티",
    tagline: "보스턴의 진한 크림 조개소스",
    category: "spaghetti",
    image: "/assets/menu/clam-chowder-spaghetti.png",
  },
  {
    id: "clam-chowder-sausage-spaghetti",
    name: "클램차우더소세지스파게티",
    tagline: "통소시지 올린 크림 클램차우더",
    category: "spaghetti",
    image: "/assets/menu/clam-chowder-sausage-spaghetti.png",
  },
  {
    id: "clam-chowder-woosamgyeop-spaghetti",
    name: "클램차우더우삼겹스파게티",
    tagline: "불향 우삼겹과 크림 클램차우더",
    category: "spaghetti",
    image: "/assets/menu/clam-chowder-woosamgyeop-spaghetti.png",
  },
  {
    id: "woosamgyeop-haejang-pasta",
    name: "우삼겹해장파스타",
